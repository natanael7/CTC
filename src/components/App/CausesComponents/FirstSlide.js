...
function FirstSlide(){
    return(
        <div>
            <div className="hero-wrap" style={{backgroundImage: 'url("images/bg_5.jpg")'}} data-stellar-background-ratio="0.5">
            ...
            <div className="container">
                ...
                <div className="col-md-7 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
                    ...
                    <h1 className="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Causes</h1>
                </div>
                </div>
            </div>
            </div>                       
